...
:   m_left_front(DrivetrainConstants::MP_LEFT_FRONT), 
    ...
    mg_left({m_left_front, m_left_rear, m_left_ext}),
    mg_right({m_right_front, m_right_rear, m_right_ext}),
...
double Drivetrain_Subsystem::getPitch(){
    return s_inertial.get_pitch();
}

double Drivetrain_Subsystem::getAccel(){
    return s_inertial.get_accel().x;
}
...
void Drivetrain_Subsystem::joystickControl(pros::Controller controller) 
{
    ...
    // mg_left.move(controller.get_analog(ANALOG_RIGHT_Y) + controller.get_analog(ANALOG_RIGHT_X));
    // m_left_ext.move(controller.get_analog(ANALOG_RIGHT_Y) + controller.get_analog(ANALOG_RIGHT_X)); 
    // mg_right.move(controller.get_analog(ANALOG_RIGHT_Y) - controller.get_analog(ANALOG_RIGHT_X)); 
    // m_right_ext.move(controller.get_analog(ANALOG_RIGHT_Y) - controller.get_analog(ANALOG_RIGHT_X));
}
